...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $message = "<i class="fa-solid fa-circle-check" style="color: #2e7d32;"></i> Yêu cầu đặt lại mật khẩu đã được gửi. Vui lòng chờ admin duyệt.";
        $message_class = 'success';
    } else {
        $message = "<i class="fa-solid fa-circle-xmark" style="color: #d32f2f;"></i> Email hoặc tên đăng nhập không tồn tại.";
        $message_class = 'error';
    }
    $stmt->close();
}
