    ...
    if (!$name || !$phone || !$address || !$payment) {
        ...
        try {
            ...
            if ($payment === 'VNPAY') {
                ...
                echo "<script>
                    window.showToast('Đặt hàng thành công! Mã đơn: #$order_id', 'success');
                    location='/Cake/index.php';
                </script>";
                exit;
            }
            ...
            echo "<script>window.showToast('Lỗi hệ thống, vui lòng thử lại!', 'error');</script>";
        }
    }
}
?>
...
<head>
    ...
    <style>
        ...
        label { font-weight: 600; margin-top: 15px; display: block; color: #355e4f; }
        ...
        input:focus, textarea:focus { border-color: #457762; outline: none; }
        ...
        .btn-submit:hover { transform: translateY(-3px); background: linear-gradient(135deg, #ff6b9c, #ff8fb3); }
